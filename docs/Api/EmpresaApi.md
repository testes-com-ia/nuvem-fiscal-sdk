...
```php
alterarConfigCteOs($cpf_cnpj, $body): \NuvemFiscal\Model\EmpresaConfigCteOs
```
...
$cpf_cnpj = 'cpf_cnpj_example'; // string | CPF ou CNPJ da empresa.  Utilize o valor sem máscara.
$body = new \NuvemFiscal\Model\EmpresaConfigCteOs(); // \NuvemFiscal\Model\EmpresaConfigCteOs
...
| ------------- | ------------- | ------------- | ------------- |
| **cpf_cnpj** | **string**| CPF ou CNPJ da empresa.  Utilize o valor sem máscara. | |
| **body** | [**\NuvemFiscal\Model\EmpresaConfigCteOs**](../Model/EmpresaConfigCteOs.md)|  | |

### Tipo do retorno

[**\NuvemFiscal\Model\EmpresaConfigCteOs**](../Model/EmpresaConfigCteOs.md)
...
```php
alterarConfigDce($cpf_cnpj, $body): \NuvemFiscal\Model\EmpresaConfigDce
```
...
$cpf_cnpj = 'cpf_cnpj_example'; // string | CPF ou CNPJ da empresa.  Utilize o valor sem máscara.
$body = new \NuvemFiscal\Model\EmpresaConfigDce(); // \NuvemFiscal\Model\EmpresaConfigDce
...
| ------------- | ------------- | ------------- | ------------- |
| **cpf_cnpj** | **string**| CPF ou CNPJ da empresa.  Utilize o valor sem máscara. | |
| **body** | [**\NuvemFiscal\Model\EmpresaConfigDce**](../Model/EmpresaConfigDce.md)|  | |

### Tipo do retorno

[**\NuvemFiscal\Model\EmpresaConfigDce**](../Model/EmpresaConfigDce.md)
...
```php
consultarConfigCteOs($cpf_cnpj): \NuvemFiscal\Model\EmpresaConfigCteOs
```
...
```php
consultarConfigDce($cpf_cnpj): \NuvemFiscal\Model\EmpresaConfigDce
```
...
```php
listarCertificados($top, $skip, $inlinecount, $expires_in, $include_expired): \NuvemFiscal\Model\EmpresaCertificadoListagem
```
...
[**\NuvemFiscal\Model\EmpresaCertificadoListagem**](../Model/EmpresaCertificadoListagem.md)
...
```php
listarEmpresas($top, $skip, $inlinecount, $cpf_cnpj, $nome_razao_social): \NuvemFiscal\Model\EmpresaListagem
```
...
try {
    $result = $apiInstance->listarEmpresas($top, $skip, $inlinecount, $cpf_cnpj, $nome_razao_social);
    print_r($result);
} catch (Exception $e) {
