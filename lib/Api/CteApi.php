...
class CteApi
{
    ...
    /**
     * Operation emitirCteSimp
     *
     * Emitir CT-e Simplificado
     *
     * @param  \NuvemFiscal\Model\CteSimpPedidoEmissao $body body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirCteSimp'] to see the possible values for this operation
     *
     * @throws \NuvemFiscal\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NuvemFiscal\Model\Dfe
     */
    public function emitirCteSimp($body, string $contentType = self::contentTypes['emitirCteSimp'][0])
    {
        list($response) = $this->emitirCteSimpWithHttpInfo($body, $contentType);
        return $response;
    }

    /**
     * Operation emitirCteSimpWithHttpInfo
     *
     * Emitir CT-e Simplificado
     *
     * @param  \NuvemFiscal\Model\CteSimpPedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirCteSimp'] to see the possible values for this operation
     *
     * @throws \NuvemFiscal\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NuvemFiscal\Model\Dfe, HTTP status code, HTTP response headers (array of strings)
     */
    public function emitirCteSimpWithHttpInfo($body, string $contentType = self::contentTypes['emitirCteSimp'][0])
    {
        $request = $this->emitirCteSimpRequest($body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function emitirCteSimpAsync($body, string $contentType = self::contentTypes['emitirCteSimp'][0])
    {
        return $this->emitirCteSimpAsyncWithHttpInfo($body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation emitirCteSimpAsyncWithHttpInfo
     *
     * Emitir CT-e Simplificado
     *
     * @param  \NuvemFiscal\Model\CteSimpPedidoEmissao $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function emitirCteSimpAsyncWithHttpInfo($body, string $contentType = self::contentTypes['emitirCteSimp'][0])
    {
        $returnType = '\NuvemFiscal\Model\Dfe';
        $request = $this->emitirCteSimpRequest($body, $contentType);
    ...
    /**
     * Create request for operation 'emitirCteSimp'
     *
     * @param  \NuvemFiscal\Model\CteSimpPedidoEmissao $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emitirCteSimp'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function emitirCteSimpRequest($body, string $contentType = self::contentTypes['emitirCteSimp'][0])
    {

        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling emitirCteSimp'
            );
        }


        $resourcePath = '/cte/simp';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
