...
/**
 * CteCartaCorrecao Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class CteCartaCorrecao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteCartaCorrecao';
    ...
    protected static $openAPITypes = [
        'correcoes' => '\NuvemFiscal\Model\CteInfCorrecao[]',
        'id' => 'string',
        'ambiente' => 'string',
        'status' => 'string',
    ...
    */
     ...
     * Gets correcoes
     *
     * @return \NuvemFiscal\Model\CteInfCorrecao[]
     */
     ...
     * Sets correcoes
     *
     * @param \NuvemFiscal\Model\CteInfCorrecao[] $correcoes Grupo de Informações de Correção.
     *
     * @return self
     */
