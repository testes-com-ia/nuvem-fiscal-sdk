...
class NfeSefazIde implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'd_prev_entrega' => 'setDPrevEntrega',
        'tp_nf' => 'setTpNf',
        'id_dest' => 'setIdDest',
        'c_mun_fg' => 'setCMunFg',
    ...
    protected static $getters = [
        ...
        'd_prev_entrega' => 'getDPrevEntrega',
        'tp_nf' => 'getTpNf',
        'id_dest' => 'getIdDest',
        'c_mun_fg' => 'getCMunFg',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('d_prev_entrega', $data ?? [], null);
    ...
    */
     ...
     * @return \DateTime|null
     */
    public function getDPrevEntrega()
    {
        return $this->container['d_prev_entrega'];
    }

    /**
     * Sets d_prev_entrega
     *
     * @param \DateTime|null $d_prev_entrega Data da previsão de entrega ou disponibilização do bem (AAAA-MM-DD).
     *
     * @return self
     */
    public function setDPrevEntrega($d_prev_entrega)
    {
        if (is_null($d_prev_entrega)) {
            array_push($this->openAPINullablesSetToNull, 'd_prev_entrega');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('d_prev_entrega', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['d_prev_entrega'] = $d_prev_entrega;
