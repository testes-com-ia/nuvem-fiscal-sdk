...
/**
 * NfcomSefazCIBS Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class NfcomSefazCIBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfcomSefazCIBS';
    ...
    protected static $openAPITypes = [
        'v_bc' => 'float',
        'g_ibsuf' => '\NuvemFiscal\Model\NfcomSefazGIBSUF',
        'g_ibs_mun' => '\NuvemFiscal\Model\NfcomSefazGIBSMun',
        'v_ibs' => 'float',
        'g_cbs' => '\NuvemFiscal\Model\NfcomSefazGCBS',
        'g_trib_regular' => '\NuvemFiscal\Model\NfcomSefazTribRegular',
        'g_trib_compra_gov' => '\NuvemFiscal\Model\NfcomSefazTribCompraGov'
    ];
    ...
    */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling NfcomSefazCIBS., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_ibsuf
     *
     * @return \NuvemFiscal\Model\NfcomSefazGIBSUF
     */
     ...
     * Sets g_ibsuf
     *
     * @param \NuvemFiscal\Model\NfcomSefazGIBSUF $g_ibsuf g_ibsuf
     *
     * @return self
     */
     ...
     * Gets g_ibs_mun
     *
     * @return \NuvemFiscal\Model\NfcomSefazGIBSMun
     */
     ...
     * Sets g_ibs_mun
     *
     * @param \NuvemFiscal\Model\NfcomSefazGIBSMun $g_ibs_mun g_ibs_mun
     *
     * @return self
     */
    ...
    public function setVIbs($v_ibs)
    {
        ...
        if (!is_null($v_ibs) && ($v_ibs < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_ibs when calling NfcomSefazCIBS., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_cbs
     *
     * @return \NuvemFiscal\Model\NfcomSefazGCBS
     */
     ...
     * Sets g_cbs
     *
     * @param \NuvemFiscal\Model\NfcomSefazGCBS $g_cbs g_cbs
     *
     * @return self
     */
     ...
     * Gets g_trib_regular
     *
     * @return \NuvemFiscal\Model\NfcomSefazTribRegular|null
     */
     ...
     * Sets g_trib_regular
     *
     * @param \NuvemFiscal\Model\NfcomSefazTribRegular|null $g_trib_regular g_trib_regular
     *
     * @return self
     */
     ...
     *
     * @return \NuvemFiscal\Model\NfcomSefazTribCompraGov|null
     */
     ...
     *
     * @param \NuvemFiscal\Model\NfcomSefazTribCompraGov|null $g_trib_compra_gov g_trib_compra_gov
     *
     * @return self
     */
