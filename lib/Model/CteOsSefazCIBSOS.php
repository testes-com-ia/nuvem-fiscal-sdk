...
/**
 * CteOsSefazCIBSOS Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class CteOsSefazCIBSOS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsSefazCIBSOS';
    ...
    protected static $openAPITypes = [
        'v_bc' => 'float',
        'g_ibsuf' => '\NuvemFiscal\Model\CteOsSefazGIBSUFOS',
        'g_ibs_mun' => '\NuvemFiscal\Model\CteOsSefazGIBSMunOS',
        'v_ibs' => 'float',
        'g_cbs' => '\NuvemFiscal\Model\CteOsSefazGCBSOS',
        'g_trib_regular' => '\NuvemFiscal\Model\CteOsSefazTribRegularOS',
        'g_trib_compra_gov' => '\NuvemFiscal\Model\CteOsSefazTribCompraGovOS'
    ];
    ...
    */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling CteOsSefazCIBSOS., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_ibsuf
     *
     * @return \NuvemFiscal\Model\CteOsSefazGIBSUFOS
     */
     ...
     * Sets g_ibsuf
     *
     * @param \NuvemFiscal\Model\CteOsSefazGIBSUFOS $g_ibsuf g_ibsuf
     *
     * @return self
     */
     ...
     * Gets g_ibs_mun
     *
     * @return \NuvemFiscal\Model\CteOsSefazGIBSMunOS
     */
     ...
     * Sets g_ibs_mun
     *
     * @param \NuvemFiscal\Model\CteOsSefazGIBSMunOS $g_ibs_mun g_ibs_mun
     *
     * @return self
     */
    ...
    public function setVIbs($v_ibs)
    {
        ...
        if (!is_null($v_ibs) && ($v_ibs < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_ibs when calling CteOsSefazCIBSOS., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_cbs
     *
     * @return \NuvemFiscal\Model\CteOsSefazGCBSOS
     */
     ...
     * Sets g_cbs
     *
     * @param \NuvemFiscal\Model\CteOsSefazGCBSOS $g_cbs g_cbs
     *
     * @return self
     */
     ...
     * Gets g_trib_regular
     *
     * @return \NuvemFiscal\Model\CteOsSefazTribRegularOS|null
     */
     ...
     * Sets g_trib_regular
     *
     * @param \NuvemFiscal\Model\CteOsSefazTribRegularOS|null $g_trib_regular g_trib_regular
     *
     * @return self
     */
     ...
     *
     * @return \NuvemFiscal\Model\CteOsSefazTribCompraGovOS|null
     */
     ...
     *
     * @param \NuvemFiscal\Model\CteOsSefazTribCompraGovOS|null $g_trib_compra_gov g_trib_compra_gov
     *
     * @return self
     */
