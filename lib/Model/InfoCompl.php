...
class InfoCompl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'doc_ref' => 'string',
        'x_ped' => 'string',
        'g_item_ped' => '\NuvemFiscal\Model\InfoItemPed',
        'x_inf_comp' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('g_item_ped', $data ?? [], null);
    ...
    */
     ...
     * Sets x_ped
     *
     * @param string|null $x_ped Número do  pedido/ordem de compra/ordem de serviço/projeto que autorize a prestação do serviço em operações B2B - Informação de interesse do tomador do serviço para controle e gestão da Negociação.
     *
     * @return self
     */
    public function setXPed($x_ped)
    {
        ...
        if (!is_null($x_ped) && (mb_strlen($x_ped) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_ped when calling InfoCompl., must be smaller than or equal to 60.');
        }
        if (!is_null($x_ped) && (mb_strlen($x_ped) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_ped when calling InfoCompl., must be bigger than or equal to 1.');
        }
     ...
     * Gets g_item_ped
     *
     * @return \NuvemFiscal\Model\InfoItemPed|null
     */
    public function getGItemPed()
    {
        return $this->container['g_item_ped'];
    }

    /**
     * Sets g_item_ped
     *
     * @param \NuvemFiscal\Model\InfoItemPed|null $g_item_ped g_item_ped
     *
     * @return self
     */
    public function setGItemPed($g_item_ped)
    {
        if (is_null($g_item_ped)) {
            throw new \InvalidArgumentException('non-nullable g_item_ped cannot be null');
        }
        $this->container['g_item_ped'] = $g_item_ped;
