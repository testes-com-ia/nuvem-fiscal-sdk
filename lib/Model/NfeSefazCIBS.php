...
/**
 * NfeSefazCIBS Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class NfeSefazCIBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazCIBS';
    ...
    protected static $openAPITypes = [
        'v_bc' => 'float',
        'g_ibsuf' => '\NuvemFiscal\Model\NfeSefazGIBSUF',
        'g_ibs_mun' => '\NuvemFiscal\Model\NfeSefazGIBSMun',
        'v_ibs' => 'float',
        'g_cbs' => '\NuvemFiscal\Model\NfeSefazGCBS',
        'g_trib_regular' => '\NuvemFiscal\Model\NfeSefazTribRegular',
        'g_trib_compra_gov' => '\NuvemFiscal\Model\NfeSefazTribCompraGov'
    ];
    ...
    */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling NfeSefazCIBS., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_ibsuf
     *
     * @return \NuvemFiscal\Model\NfeSefazGIBSUF
     */
     ...
     * Sets g_ibsuf
     *
     * @param \NuvemFiscal\Model\NfeSefazGIBSUF $g_ibsuf g_ibsuf
     *
     * @return self
     */
     ...
     * Gets g_ibs_mun
     *
     * @return \NuvemFiscal\Model\NfeSefazGIBSMun
     */
     ...
     * Sets g_ibs_mun
     *
     * @param \NuvemFiscal\Model\NfeSefazGIBSMun $g_ibs_mun g_ibs_mun
     *
     * @return self
     */
    ...
    public function setVIbs($v_ibs)
    {
        ...
        if (!is_null($v_ibs) && ($v_ibs < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_ibs when calling NfeSefazCIBS., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_cbs
     *
     * @return \NuvemFiscal\Model\NfeSefazGCBS
     */
     ...
     * Sets g_cbs
     *
     * @param \NuvemFiscal\Model\NfeSefazGCBS $g_cbs g_cbs
     *
     * @return self
     */
     ...
     * Gets g_trib_regular
     *
     * @return \NuvemFiscal\Model\NfeSefazTribRegular|null
     */
     ...
     * Sets g_trib_regular
     *
     * @param \NuvemFiscal\Model\NfeSefazTribRegular|null $g_trib_regular g_trib_regular
     *
     * @return self
     */
     ...
     *
     * @return \NuvemFiscal\Model\NfeSefazTribCompraGov|null
     */
     ...
     *
     * @param \NuvemFiscal\Model\NfeSefazTribCompraGov|null $g_trib_compra_gov g_trib_compra_gov
     *
     * @return self
     */
