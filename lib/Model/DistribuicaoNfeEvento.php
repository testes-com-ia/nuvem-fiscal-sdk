...
/**
 * DistribuicaoNfeEvento Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class DistribuicaoNfeEvento implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistribuicaoNfeEvento';
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'cpf_cnpj_autor' => 'setCpfCnpjAutor',
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'cpf_cnpj_autor' => 'getCpfCnpjAutor',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cpf_cnpj_autor', $data ?? [], null);
        ...
        $this->setIfExists('data_registro', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getCpfCnpjAutor()
    {
        return $this->container['cpf_cnpj_autor'];
    }

    /**
     * Sets cpf_cnpj_autor
     *
     * @param string|null $cpf_cnpj_autor CPF/CNPJ do autor do evento.
     *
     * @return self
     */
    public function setCpfCnpjAutor($cpf_cnpj_autor)
    {
        if (is_null($cpf_cnpj_autor)) {
            throw new \InvalidArgumentException('non-nullable cpf_cnpj_autor cannot be null');
        }
        $this->container['cpf_cnpj_autor'] = $cpf_cnpj_autor;
     ...
     * Sets tipo_evento
     *
     * @param string|null $tipo_evento Tipo do evento vinculado.
     *
     * @return self
     */
     ...
     * Sets justificativa
     *
     * @param string|null $justificativa Justificativa para o desconhecimento ou não-realização da operação.
     *
     * @return self
     */
     ...
     * Sets data_registro
     *
     * @param \DateTime|null $data_registro Data e hora do registro do evento pela SEFAZ.
     *
     * @return self
     */
    public function setDataRegistro($data_registro)
    {
        if (is_null($data_registro)) {
            array_push($this->openAPINullablesSetToNull, 'data_registro');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('data_registro', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
