...
/**
 * RTCInfoImovel Class Doc Comment
 *
 * @category Class
 ...
 */
class RTCInfoImovel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RTCInfoImovel';
    ...
    */
    ...
    public function setInscImobFisc($insc_imob_fisc)
    {
        ...
        if (!is_null($insc_imob_fisc) && (mb_strlen($insc_imob_fisc) > 30)) {
            throw new \InvalidArgumentException('invalid length for $insc_imob_fisc when calling RTCInfoImovel., must be smaller than or equal to 30.');
        }
        if (!is_null($insc_imob_fisc) && (mb_strlen($insc_imob_fisc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $insc_imob_fisc when calling RTCInfoImovel., must be bigger than or equal to 1.');
        }
    ...
    public function setCCib($c_cib)
    {
        ...
        if (!is_null($c_cib) && (mb_strlen($c_cib) > 8)) {
            throw new \InvalidArgumentException('invalid length for $c_cib when calling RTCInfoImovel., must be smaller than or equal to 8.');
        }
