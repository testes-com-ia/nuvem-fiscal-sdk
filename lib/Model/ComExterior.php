...
class ComExterior implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets md_prestacao
     *
     * @param int $md_prestacao Modo de Prestação:  * 0 - Desconhecido (tipo não informado na nota de origem)  * 1 - Transfronteiriço  * 2 - Consumo no Brasil  * 3 - Movimento Temporário de Pessoas Físicas  * 4 - Consumo no Exterior
     *
     * @return self
     */
     ...
     * Sets mov_temp_bens
     *
     * @param int $mov_temp_bens Vínculo da Operação à Movimentação Temporária de Bens:  * 0 - Desconhecido (tipo não informado na nota de origem)  * 1 - Não  * 2 - Vinculada - Declaração de Importação  * 3 - Vinculada - Declaração de Exportação
     *
     * @return self
     */
