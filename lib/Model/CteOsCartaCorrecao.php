...
/**
 * CteOsCartaCorrecao Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class CteOsCartaCorrecao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteOsCartaCorrecao';
    ...
    protected static $openAPITypes = [
        'correcoes' => '\NuvemFiscal\Model\CteOsInfCorrecao[]',
        'id' => 'string',
        'ambiente' => 'string',
        'status' => 'string',
    ...
    {
        $this->setIfExists('correcoes', $data ?? [], null);
    ...
    */
     ...
     * Gets correcoes
     *
     * @return \NuvemFiscal\Model\CteOsInfCorrecao[]
     */
    public function getCorrecoes()
    {
        return $this->container['correcoes'];
    }

    /**
     * Sets correcoes
     *
     * @param \NuvemFiscal\Model\CteOsInfCorrecao[] $correcoes Grupo de Informações de Correção.
     *
     * @return self
     */
    public function setCorrecoes($correcoes)
    {
        ...
        if ((count($correcoes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $correcoes when calling CteOsCartaCorrecao., number of items must be greater than or equal to 1.');
        }
