...
/**
 * DfeCartaCorrecao Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class DfeCartaCorrecao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DfeCartaCorrecao';
    ...
    {
        $this->setIfExists('correcao', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['correcao'];
    }

    /**
     * Sets correcao
     *
     * @param string|null $correcao Correção a ser considerada.
     *
     * @return self
     */
    ...
    {
        if (is_null($correcao)) {
            throw new \InvalidArgumentException('non-nullable correcao cannot be null');
        }
        $this->container['correcao'] = $correcao;
