...
/**
 * CteSimpSefazCIBSSimp Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class CteSimpSefazCIBSSimp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSimpSefazCIBSSimp';
    ...
    protected static $openAPITypes = [
        'v_bc' => 'float',
        'g_ibsuf' => '\NuvemFiscal\Model\CteSimpSefazGIBSUFSimp',
        'g_ibs_mun' => '\NuvemFiscal\Model\CteSimpSefazGIBSMunSimp',
        'v_ibs' => 'float',
        'g_cbs' => '\NuvemFiscal\Model\CteSimpSefazGCBSSimp',
        'g_trib_regular' => '\NuvemFiscal\Model\CteSimpSefazTribRegularSimp',
        'g_trib_compra_gov' => '\NuvemFiscal\Model\CteSimpSefazTribCompraGovSimp'
    ];
    ...
    */
    ...
    public function setVBc($v_bc)
    {
        ...
        if (!is_null($v_bc) && ($v_bc < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_bc when calling CteSimpSefazCIBSSimp., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_ibsuf
     *
     * @return \NuvemFiscal\Model\CteSimpSefazGIBSUFSimp
     */
     ...
     * Sets g_ibsuf
     *
     * @param \NuvemFiscal\Model\CteSimpSefazGIBSUFSimp $g_ibsuf g_ibsuf
     *
     * @return self
     */
     ...
     * Gets g_ibs_mun
     *
     * @return \NuvemFiscal\Model\CteSimpSefazGIBSMunSimp
     */
     ...
     * Sets g_ibs_mun
     *
     * @param \NuvemFiscal\Model\CteSimpSefazGIBSMunSimp $g_ibs_mun g_ibs_mun
     *
     * @return self
     */
    ...
    public function setVIbs($v_ibs)
    {
        ...
        if (!is_null($v_ibs) && ($v_ibs < 0)) {
            throw new \InvalidArgumentException('invalid value for $v_ibs when calling CteSimpSefazCIBSSimp., must be bigger than or equal to 0.');
        }
     ...
     * Gets g_cbs
     *
     * @return \NuvemFiscal\Model\CteSimpSefazGCBSSimp
     */
     ...
     * Sets g_cbs
     *
     * @param \NuvemFiscal\Model\CteSimpSefazGCBSSimp $g_cbs g_cbs
     *
     * @return self
     */
     ...
     * Gets g_trib_regular
     *
     * @return \NuvemFiscal\Model\CteSimpSefazTribRegularSimp|null
     */
     ...
     * Sets g_trib_regular
     *
     * @param \NuvemFiscal\Model\CteSimpSefazTribRegularSimp|null $g_trib_regular g_trib_regular
     *
     * @return self
     */
     ...
     *
     * @return \NuvemFiscal\Model\CteSimpSefazTribCompraGovSimp|null
     */
     ...
     *
     * @param \NuvemFiscal\Model\CteSimpSefazTribCompraGovSimp|null $g_trib_compra_gov g_trib_compra_gov
     *
     * @return self
     */
