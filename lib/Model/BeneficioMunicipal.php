...
/**
 * BeneficioMunicipal Class Doc Comment
 *
 * @category Class
 ...
 */
class BeneficioMunicipal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BeneficioMunicipal';
    ...
    protected static $setters = [
        'tp_bm' => 'setTpBm',
        'n_bm' => 'setNBm',
        'v_red_bcbm' => 'setVRedBcbm',
        'p_red_bcbm' => 'setPRedBcbm'
    ];
    ...
    protected static $getters = [
        'tp_bm' => 'getTpBm',
        'n_bm' => 'getNBm',
        'v_red_bcbm' => 'getVRedBcbm',
        'p_red_bcbm' => 'getPRedBcbm'
    ];
    ...
    {
        $this->setIfExists('tp_bm', $data ?? [], null);
        $this->setIfExists('n_bm', $data ?? [], null);
        $this->setIfExists('v_red_bcbm', $data ?? [], null);
        $this->setIfExists('p_red_bcbm', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getTpBm()
    {
        return $this->container['tp_bm'];
    }

    /**
     * Sets tp_bm
     *
     * @param int|null $tp_bm Tipo do Benefício Municipal:  * 1 - Alíquota Diferenciada  * 2 - Redução da BC  * 3 - Isenção    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado.
     *
     * @return self
     */
    ...
    {
        return $this->container['n_bm'];
    }

    /**
     * Sets n_bm
     *
     * @param string $n_bm Identificador do benefício parametrizado pelo município.  Trata-se de um identificador único que foi gerado pelo Sistema Nacional no momento em que o município de incidência do ISSQN incluiu o benefício no sistema.  Critério de formação do número de identificação de parâmetros municipais:  7 dígitos - posição 1 a 7: número identificador do Município, conforme código IBGE  2 dígitos - posições 8 e 9 : número identificador do tipo de parametrização (01-legislação, 02-regimes especiais, 03-retenções, 04-outros benefícios)  5 dígitos - posição 10 a 14 : número sequencial definido pelo sistema quando do registro específico do parâmetro dentro do tipo de parametrização no sistema.
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getVRedBcbm()
    {
        return $this->container['v_red_bcbm'];
    }

    /**
     * Sets v_red_bcbm
     *
     * @param float|null $v_red_bcbm Valor monetário informado pelo emitente para redução da base de cálculo (BC) do ISSQN devido a um Benefício Municipal (BM).
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getPRedBcbm()
    {
        return $this->container['p_red_bcbm'];
    }

    /**
     * Sets p_red_bcbm
     *
     * @param float|null $p_red_bcbm Valor percentual informado pelo emitente para redução da base de cálculo (BC) do ISSQN devido a um Benefício Municipal (BM).
     *
     * @return self
     */
