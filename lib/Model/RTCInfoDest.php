 ...
 */
class RTCInfoDest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RTCInfoDest';
    ...
    */
     ...
     * Sets cnpj
     *
     * @param string|null $cnpj Número da inscrição no Cadastro Nacional de Pessoa Jurídica (CNPJ) do Destinatário do serviço.
     *
     * @return self
     */
    public function setCnpj($cnpj)
    {
        ...
        if (!is_null($cnpj) && (mb_strlen($cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $cnpj when calling RTCInfoDest., must be smaller than or equal to 14.');
        }
     ...
     * Sets cpf
     *
     * @param string|null $cpf Número da inscrição no Cadastro de Pessoa Física (CPF) do Destinatário do serviço.
     *
     * @return self
     */
    public function setCpf($cpf)
    {
        ...
        if (!is_null($cpf) && (mb_strlen($cpf) > 11)) {
            throw new \InvalidArgumentException('invalid length for $cpf when calling RTCInfoDest., must be smaller than or equal to 11.');
        }
    ...
    public function setNif($nif)
    {
        ...
        if (!is_null($nif) && (mb_strlen($nif) > 40)) {
            throw new \InvalidArgumentException('invalid length for $nif when calling RTCInfoDest., must be smaller than or equal to 40.');
        }
        if (!is_null($nif) && (mb_strlen($nif) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nif when calling RTCInfoDest., must be bigger than or equal to 1.');
        }
     ...
     * Sets x_nome
     *
     * @param string $x_nome Nome / Nome Empresarial do do Destinatário do serviço.
     *
     * @return self
     */
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 150)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling RTCInfoDest., must be smaller than or equal to 150.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling RTCInfoDest., must be bigger than or equal to 1.');
        }
     ...
     * Sets fone
     *
     * @param string|null $fone Número do telefone do Destinatário do serviço  (Preencher com o Código DDD + número do telefone. Nas operações com exterior é permitido informar o  código do país + código da localidade + número do telefone).
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email * E-mail do Destinatário do serviço
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 80)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RTCInfoDest., must be smaller than or equal to 80.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RTCInfoDest., must be bigger than or equal to 1.');
        }
