    ...
    */
    ...
    public function setCnpj($cnpj)
    {
        ...
        if (!is_null($cnpj) && (mb_strlen($cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $cnpj when calling InfoFornecDocDedRed., must be smaller than or equal to 14.');
        }
    ...
    public function setCpf($cpf)
    {
        ...
        if (!is_null($cpf) && (mb_strlen($cpf) > 11)) {
            throw new \InvalidArgumentException('invalid length for $cpf when calling InfoFornecDocDedRed., must be smaller than or equal to 11.');
        }
    ...
    public function setNif($nif)
    {
        ...
        if (!is_null($nif) && (mb_strlen($nif) > 40)) {
            throw new \InvalidArgumentException('invalid length for $nif when calling InfoFornecDocDedRed., must be smaller than or equal to 40.');
        }
        if (!is_null($nif) && (mb_strlen($nif) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nif when calling InfoFornecDocDedRed., must be bigger than or equal to 1.');
        }
     ...
     * Sets caepf
     *
     * @param string|null $caepf Número do Cadastro de Atividade Econômica da Pessoa Física (CAEPF) do tomador, intermediário ou fornecedor do serviço.
     *
     * @return self
     */
    public function setCaepf($caepf)
    {
        ...
        if (!is_null($caepf) && (mb_strlen($caepf) > 14)) {
            throw new \InvalidArgumentException('invalid length for $caepf when calling InfoFornecDocDedRed., must be smaller than or equal to 14.');
        }
    ...
    public function setIm($im)
    {
        ...
        if (!is_null($im) && (mb_strlen($im) > 15)) {
            throw new \InvalidArgumentException('invalid length for $im when calling InfoFornecDocDedRed., must be smaller than or equal to 15.');
        }
        if (!is_null($im) && (mb_strlen($im) < 1)) {
            throw new \InvalidArgumentException('invalid length for $im when calling InfoFornecDocDedRed., must be bigger than or equal to 1.');
        }
    ...
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 300)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling InfoFornecDocDedRed., must be smaller than or equal to 300.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling InfoFornecDocDedRed., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 80)) {
            throw new \InvalidArgumentException('invalid length for $email when calling InfoFornecDocDedRed., must be smaller than or equal to 80.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling InfoFornecDocDedRed., must be bigger than or equal to 1.');
        }
