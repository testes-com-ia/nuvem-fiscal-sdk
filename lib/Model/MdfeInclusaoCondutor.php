...
/**
 * MdfeInclusaoCondutor Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class MdfeInclusaoCondutor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeInclusaoCondutor';
    ...
    protected static $setters = [
        'nome_condutor' => 'setNomeCondutor',
        'cpf_condutor' => 'setCpfCondutor',
        'id' => 'setId',
    ...
    protected static $getters = [
        'nome_condutor' => 'getNomeCondutor',
        'cpf_condutor' => 'getCpfCondutor',
        'id' => 'getId',
    ...
    {
        $this->setIfExists('nome_condutor', $data ?? [], null);
        $this->setIfExists('cpf_condutor', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getNomeCondutor()
    {
        return $this->container['nome_condutor'];
    }

    /**
     * Sets nome_condutor
     *
     * @param string|null $nome_condutor Nome do condutor.
     *
     * @return self
     */
    public function setNomeCondutor($nome_condutor)
    {
     ...
     * @return string|null
     */
    public function getCpfCondutor()
    {
        return $this->container['cpf_condutor'];
    }

    /**
     * Sets cpf_condutor
     *
     * @param string|null $cpf_condutor CPF do condutor.
     *
     * @return self
     */
    public function setCpfCondutor($cpf_condutor)
    {
        if (is_null($cpf_condutor)) {
            throw new \InvalidArgumentException('non-nullable cpf_condutor cannot be null');
        }
        $this->container['cpf_condutor'] = $cpf_condutor;
